...
public class InstancesOfServiceRequest extends RabbitMQConsumer {

    public InstancesOfServiceRequest( RabbitMQBasicReceiver receiver ) {
        super( receiver );
    }
    ...
    public void handleDelivery( String consumerTag, Envelope envelope, BasicProperties properties, byte[] body )
            throws IOException {
        Logger.getLogger( getClass() ).debug( "received instances of service request..." );
        Actions.getInstance().instancesOfService( new String( body ) );
        // logs the end of the operation
        Logger.getLogger( getClass() ).debug( "received instances of service request... done." );
