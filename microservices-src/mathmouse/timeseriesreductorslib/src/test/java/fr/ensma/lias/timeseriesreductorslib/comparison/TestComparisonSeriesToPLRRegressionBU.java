...
public class TestComparisonSeriesToPLRRegressionBU {
    public static final String            STATIC_LOGGER  = "STATIC_LOGGER:TestComparisonSeriesToPLRRegressionBU";
    ...
    public void intialize() {
        ...
        experiement1 = new Experiment( "PLRRegressionBU1" );
        experiement2 = new Experiment( "PLRRegressionBU2" );
        experiement3 = new Experiment( "PLRRegressionBU3" );
        ...
        segmentsBU1 = new PLRRegressionBU( rawSeries1 );

        segmentsBU1.process( MAX_ERROR );

        Logger.getLogger( getClass() ).debug( "segments 1 size" );
        try {
            experiement1.putMemorySize( (double) Memory.printSegmentSize( segmentsBU1.getRegressionSegments() ) );
            experiement1.putNumberOfElements( (double) segmentsBU1.getRegressionSegments().size() );
        } catch ( Exception e ) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }

        segmentsBU2 = new PLRRegressionBU( rawSeries2 );
        segmentsBU2.process( MAX_ERROR );

        Logger.getLogger( getClass() ).debug( "segments 2 size" );
        try {
            experiement2.putMemorySize( (double) Memory.printSegmentSize( segmentsBU2.getRegressionSegments() ) );
            experiement2.putNumberOfElements( (double) segmentsBU2.getRegressionSegments().size() );
        } catch ( Exception e ) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
        ...
        segmentsBU3 = new PLRRegressionBU( rawSeries3 );
        ...
        try {
            experiement3.putMemorySize( (double) Memory.printSegmentSize( segmentsBU3.getRegressionSegments() ) );
            experiement3.putNumberOfElements( (double) segmentsBU3.getRegressionSegments().size() );
        } catch ( Exception e ) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
        ...
        for ( int i = 0; i < N; i++ ) {
            ...
            series1.putAll( segmentsBU1.getRegressionSegments().computeValues( rawSeries1.keySet() ) );
        ...
        Logger.getLogger( getClass() ).debug( "segments 1:" + segmentsBU1.getRegressionSegments().size() );
        ...
        for ( int i = 0; i < N; i++ ) {
            intermediateTime = System.nanoTime();
            series2.putAll( segmentsBU2.getRegressionSegments().computeValues( rawSeries2.keySet() ) );
            intermediateTime = System.nanoTime() - intermediateTime;
            time = time + intermediateTime;
            if ( i != N - 1 )
                series2.clear();
        ...
        Logger.getLogger( getClass() ).debug( "segments 2:" + segmentsBU2.getRegressionSegments().size() );
        ...
        for ( int i = 0; i < N; i++ ) {
            intermediateTime = System.nanoTime();
            series3.putAll( segmentsBU3.getRegressionSegments().computeValues( rawSeries3.keySet() ) );
            intermediateTime = System.nanoTime() - intermediateTime;
            time = time + intermediateTime;
            if ( i != N - 1 )
                series3.clear();
        ...
        Logger.getLogger( getClass() ).debug( "segments 3:" + segmentsBU3.getRegressionSegments().size() );
