...
public class TestComparisonModelToSeries {
    ...
    private static final String           SERIES_1_PATH    = "src/test/resources/timeseries-sources/Data1.csv";
    private static final String           SERIES_2_PATH    = "src/test/resources/timeseries-sources/Data2.csv";
    private static final String           SERIES_3_PATH    = "src/test/resources/timeseries-sources/Data3.csv";

    private static DifferentialEquation2  equation1        = null;
    private static DifferentialEquation2  equation2        = null;
    private static DifferentialEquation2  equation3        = null;

    private static NumericalMethod2       numericalMethod1 = null;
    private static NumericalMethod2       numericalMethod2 = null;
    private static NumericalMethod2       numericalMethod3 = null;
    ...
    public static void initialize() {
        ...
        try {
            ...
            for ( int i = 0; i < N; i++ ) {
                ...
                numericalMethod1 = new NumericalMethod2( equation1 );
                modelSeries1 = numericalMethod1.equationToTimeseriesRK4();
            ...
            for ( int i = 0; i < N; i++ ) {
                intermediateTime = System.nanoTime();
                numericalMethod2 = new NumericalMethod2( equation2 );
                modelSeries2 = numericalMethod2.equationToTimeseriesRK4();
                intermediateTime = System.nanoTime() - intermediateTime;
                time = time + intermediateTime;
                if ( i != N - 1 )
                    modelSeries2.clear();
            ...
            for ( int i = 0; i < N; i++ ) {
                intermediateTime = System.nanoTime();
                numericalMethod3 = new NumericalMethod2( equation3 );
                modelSeries3 = numericalMethod3.equationToTimeseriesRK4();
                intermediateTime = System.nanoTime() - intermediateTime;
                time = time + intermediateTime;
                if ( i != N - 1 )
                    modelSeries3.clear();
    ...
    public void test() {
        try {
            ...
            Logger.getLogger( getClass() ).debug( "model series 1: " + modelSeries1 );
            ...
            Logger.getLogger( getClass() ).debug( "model series 2: " + modelSeries2 );
            ...
            Logger.getLogger( getClass() ).debug( "model series 3: " + modelSeries3 );
