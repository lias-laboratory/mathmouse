...
public class TestComparisonSeriesToPLRInterpolateTD {
    ...
    public void intialize() {
        ...
        experiement1 = new Experiment( "PLRInterpolateTD1" );
        experiement2 = new Experiment( "PLRInterpolateTD2" );
        experiement3 = new Experiment( "PLRInterpolateTD3" );
        ...
        segmentsTD1 = new PLRInterpolateTD( rawSeries1 );

        segmentsTD1.process( MAX_ERROR );

        Logger.getLogger( getClass() ).debug( "segments 1 size" );
        try {
            experiement1.putMemorySize( (double) Memory.printSegmentSize( segmentsTD1.getInterpolateSegments() ) );
            experiement1.putNumberOfElements( (double) segmentsTD1.getInterpolateSegments().size() );
        } catch ( Exception e ) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }

        segmentsTD2 = new PLRInterpolateTD( rawSeries2 );
        ...
        try {
            experiement2.putMemorySize( (double) Memory.printSegmentSize( segmentsTD2.getInterpolateSegments() ) );
            experiement2.putNumberOfElements( (double) segmentsTD2.getInterpolateSegments().size() );
        } catch ( Exception e ) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }

        segmentsTD3 = new PLRInterpolateTD( rawSeries3 );
        ...
        try {
            experiement3.putMemorySize( (double) Memory.printSegmentSize( segmentsTD3.getInterpolateSegments() ) );
            experiement3.putNumberOfElements( (double) segmentsTD3.getInterpolateSegments().size() );
        } catch ( Exception e ) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
        ...
        for ( int i = 0; i < N; i++ ) {
            ...
            series1.putAll( segmentsTD1.getInterpolateSegments().computeValues( rawSeries1.keySet() ) );
        ...
        Logger.getLogger( getClass() ).debug( "segments 1:" + segmentsTD1.getInterpolateSegments().size() );
        ...
        for ( int i = 0; i < N; i++ ) {
            intermediateTime = System.nanoTime();
            series2.putAll( segmentsTD2.getInterpolateSegments().computeValues( rawSeries2.keySet() ) );
            intermediateTime = System.nanoTime() - intermediateTime;
            time = time + intermediateTime;
            if ( i != N - 1 )
                series2.clear();
        ...
        Logger.getLogger( getClass() ).debug( "segments 2:" + segmentsTD2.getInterpolateSegments().size() );
        ...
        for ( int i = 0; i < N; i++ ) {
            intermediateTime = System.nanoTime();
            series3.putAll( segmentsTD3.getInterpolateSegments().computeValues( rawSeries3.keySet() ) );
            intermediateTime = System.nanoTime() - intermediateTime;
            time = time + intermediateTime;
            if ( i != N - 1 )
                series3.clear();
        ...
        Logger.getLogger( getClass() ).debug( "segments 3:" + segmentsTD3.getInterpolateSegments().size() );
